...
const Products = () => {
    return (
        ...
        >
            ...
            ></Element>
            <Box className="flex-col flex justify-center items-center pt-8 max-w-[1200px] mx-auto lg:pt-0 w-full">
                <div className="top-container flex items-center justify-center w-full">
                    <div className="text-container .reveal w-full">
                        <h1
                            id="product-title"
                            className="text-center font-extrabold font-sans mb-8 text-gray-200 px-8 text-3xl md:text-5xl md:mb-12 mix-blend-difference"
                        >
