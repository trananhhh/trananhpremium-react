        ...
        <div className="flex items-center justify-center flex-col p-3">
            <div className="bg-zinc-900 rounded-3xl px-4 pt-10 pb-4 md:pb-10 w-full md:px-10 max-w-[1280px] mx-auto">
                <div className="text-container .reveal">
                    <h1 className="text-center font-extrabold font-sans mb-8 md:mb-12 text-3xl md:text-4xl text-gray-200 mx-6">
                        Thành viên của
                        <span className="font-[billCorp] opacity-90 mx-2 block md:inline-block font-normal md:font-bold">
                            trananh
